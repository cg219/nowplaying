...
func addRoutes(srv *Server) {
    ...
    srv.mux.Handle("POST /api/share-top-tracks", srv.handle(srv.UserOnly, srv.ShareTopTracks))
    srv.mux.Handle("POST /api/share-top-artists", srv.handle(srv.UserOnly, srv.ShareTopArtists))
